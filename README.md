...
|------|-------------|------|---------|:--------:|
| <a name="input_cilium"></a> [cilium](#input\_cilium) | n/a | `map(any)` | <pre>{<br>  "mesh1": {<br>    "cluster_id": 1,<br>    "version": "1.16.2"<br>  },<br>  "mesh2": {<br>    "cluster_id": 2,<br>    "version": "1.16.2"<br>  }<br>}</pre> | no |
